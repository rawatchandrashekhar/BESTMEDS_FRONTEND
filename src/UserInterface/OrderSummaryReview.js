...
export default function OrderSummaryReview(props) {
                        ...
                        <Grid container spacing={2} style={{ display: "flex", justifyContent: "center" }}>
                            ...
                            <Grid item xs={4} style={{ marginLeft: 20, height: "0%", position: "-webkit-sticky", position: "sticky", top: 70 }}>
                                <div style={{ background: "#fff", borderRadius: 10 }}>
                                    ...
                                    <div onClick={()=>navigate("/finalordersummary")} style={{ padding: 20 }}><Button variant="contained" style={{ color: "#fff", background: "#000", fontWeight: "bold", width: "40%" }}>PROCEED</Button></div>
                                </div>
